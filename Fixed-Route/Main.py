...
def main():
    ...
    start = time.time()
    List_of_solutions_with_ConstructiveAlgorithm(d, v, 1, 100)
    end = time.time()
    ...
    data_3 = Data()
    data_3.saveRoute()
    initial_neighbor = List_of_solutions_with_ConstructiveAlgorithm(data_3,vehicle_3,1,100)
    ...
    data_4 = Data()
    data_4.saveRoute()
    firstNeighborhood = List_of_solutions_with_ConstructiveAlgorithm(data_4,vehicle_4,1,100)
    ...
    data_5 = Data()
    data_5.saveRoute()
    list_of_solution_nodes_5 = List_of_solutions_with_ConstructiveAlgorithm(data_5, vehicle_5, 1, 30)
    NewCost = NoisyMethod(data_5, vehicle_5_1, 1, 100)
    print(str(vehicle_5_1.acumulatePrice) + "$")
    end = time.time()
    print("elapsed time " + str( end - start))
